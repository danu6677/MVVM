...
class PopUpWindow: UIViewController {
    ...
    init(title: String, text: String, buttontext: String,gender:String) {
        ...
        popUpWindowView.popupText.text = "Gender: \(gender.uppercased())\n\n\(text)"
        ...
        popUpWindowView.profileImageView.image = UIImage(named: gender != "female" ? "male" : "female")
    }
...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        popupTitle.backgroundColor = .lightGray
        ...
        popupButton.backgroundColor = .darkGray
        ...
        NSLayoutConstraint.activate([
            profileImageView.leadingAnchor.constraint(equalTo: popupView.leadingAnchor, constant: 80),
            profileImageView.topAnchor.constraint(equalTo: popupView.topAnchor, constant: 65),
            profileImageView.heightAnchor.constraint(equalToConstant: 127),
            profileImageView.widthAnchor.constraint(equalToConstant: 127)
            ])
        ...
        NSLayoutConstraint.activate([
            ...
            popupText.topAnchor.constraint(equalTo: profileImageView.bottomAnchor, constant: 8),
